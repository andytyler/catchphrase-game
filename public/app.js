...
img.setAttribute("src","https://vignette.wikia.nocookie.net/logopedia/images/9/9b/Catchphrase_%283%29.jpg/revision/latest?cb=20140727190104")
...
function removeRandomBox() {
    var allCovers = document.getElementsByClassName('coverBoxClass')
    allCovers = Array.from(allCovers).filter(element => !element.classList.contains('coverBoxClassHidden'))
